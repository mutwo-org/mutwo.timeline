...
class EventPlacementTest(unittest.TestCase):
    def setUp(self):
        self.event_placement_with_start_and_end = timeline_events.EventPlacement(
    ...
    def test_is_overlapping(self):
        ...
        event_placement0 = timeline_events.EventPlacement(event, 1, 2)
        event_placement1 = timeline_events.EventPlacement(event, 0, 3)
        event_placement2 = timeline_events.EventPlacement(
            event, ranges.Range(0.5, 1), ranges.Range(2.5, 4)
        )
        event_placement3 = timeline_events.EventPlacement(event, 10, 12)
        event_placement4 = timeline_events.EventPlacement(event, 2, ranges.Range(4, 10))
...
class TimeLineTest(unittest.TestCase):
    def setUp(self):
        ...
        self.timeline_static_prohibited = timeline_events.TimeLine(
            duration=self.static_duration, prohibit_overlaps=True
        )
        self.timeline_dynamic_prohibited = timeline_events.TimeLine(
            duration=None, prohibit_overlaps=True
        )
        self.timeline_dynamic_allowed = timeline_events.TimeLine(
            duration=None, prohibit_overlaps=False
        )
        self.timeline_static_allowed = timeline_events.TimeLine(
    ...
    def test_register_basic(self):
        event_placement = timeline_events.EventPlacement(self.event, 2, 5)
    ...
    def test_register_order(self):
        event_placement_tuple = (
            timeline_events.EventPlacement(self.event, 2, 4),
            timeline_events.EventPlacement(self.event, 0, 2),
            timeline_events.EventPlacement(self.event, 6, 8),
            timeline_events.EventPlacement(self.event, 4, 4.5),
            timeline_events.EventPlacement(self.event, 4.5, 6),
        )
        for timeline in self.timeline_tuple:
    ...
    def test_register_overlap(self):
        event_placement0 = timeline_events.EventPlacement(self.event, 2, 4)
        event_placement1 = timeline_events.EventPlacement(self.event, 3, 5)
    ...
    def test_register_exceeding_duration(self):
        self.assertRaises(
            ...
            timeline_events.EventPlacement(self.event, 8, 11),
        )
